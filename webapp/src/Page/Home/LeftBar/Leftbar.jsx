    ...
    return (
        <div className={main.main_left}>
            ...
            <div className={main.middle}>
                <NavLink to={""} className={count === 1 ? main.selected : main.not_Selected} onClick={() => increaseCount(1)}>
                ...
                <NavLink to={"catgeories"} className={count === 2 ? main.selected : main.not_Selected} onClick={() => increaseCount(2)}>
                    <div className={main.icons}>
                ...
                <NavLink to={"incomes"} className={count === 3 ? main.selected : main.not_Selected} onClick={() => increaseCount(3)}>
                    <div className={main.icons}>
                ...
                <NavLink to={"expenses"} className={count === 4 ? main.selected : main.not_Selected} onClick={() => increaseCount(4)}>
                    <div className={main.icons}>
                ...
                <NavLink to={"filters"} className={count === 5 ? main.selected : main.not_Selected} onClick={() => increaseCount(5)}>
                    <div className={main.icons}>
            ...
            <div className={main.bottom}>
                <NavLink to={""} className={count === 6 ? main.selected : main.not_Selected} onClick={() => increaseCount(6)}>
                    <div className={main.icons}>
                ...
                <NavLink to={""} className={count === 7 ? main.selected : main.not_Selected} onClick={() => increaseCount(7)}>
                    <div className={main.icons}>
