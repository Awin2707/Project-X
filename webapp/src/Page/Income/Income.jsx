...
function Income() {
  ...
  useEffect(() => {
    ...
    if (select.income.length != 0) {
      select.income.map((val) => {
      ...
      <div className='col-12 mt-4'>
        <div className="row g-3">
          <div className="col-6 col-sm-6 col-lg-3">
            <div className={main.navbox}>
              <div className='w-75 h-100 d-flex align-items-center justify-content-evenly flex-column px-3'>
                <label style={{ color: '#6B7280', fontSize: '16px' }}>Today Income</label>
          ...
          <div className="col-6 col-sm-6 col-lg-3">
            <div className={main.navbox}>
              <div className='w-75 h-100 d-flex align-items-center justify-content-evenly flex-column px-3'>
                <label style={{ color: '#6B7280', fontSize: '16px' }}>Weekly Income</label>
          ...
          <div className="col-6 col-sm-6 col-lg-3">
            <div className={main.navbox}>
              <div className='w-75 h-100 d-flex align-items-center justify-content-evenly flex-column px-3'>
                <label style={{ color: '#6B7280', fontSize: '16px' }}>Monthly Income</label>
          ...
          <div className="col-6 col-sm-6 col-lg-3">
            <div className={main.navbox}>
              <div className='w-75 h-100 d-flex align-items-center justify-content-evenly flex-column px-3'>
                <label style={{ color: '#6B7280', fontSize: '16px' }}>Yearly Income</label>
